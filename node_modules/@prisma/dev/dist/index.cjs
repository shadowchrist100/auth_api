...
=======
"use strict";var Lt=Object.create;var W=Object.defineProperty;var jt=Object.getOwnPropertyDescriptor;var Mt=Object.getOwnPropertyNames;var Ut=Object.getPrototypeOf,Nt=Object.prototype.hasOwnProperty;var D=(t,e)=>()=>(t&&(e=t(t=0)),e);var ae=(t,e)=>{for(var r in e)W(t,r,{get:e[r],enumerable:!0})},Ae=(t,e,r,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of Mt(e))!Nt.call(t,n)&&n!==r&&W(t,n,{get:()=>e[n],enumerable:!(o=jt(e,n))||o.enumerable});return t};var w=(t,e,r)=>(r=t!=null?Lt(Ut(t)):{},Ae(e||!t||!t.__esModule?W(r,"default",{value:t,enumerable:!0}):r,t)),qt=t=>Ae(W({},"__esModule",{value:!0}),t);var p=D(()=>{"use strict"});function _e(t){return Buffer.from(JSON.stringify(Object.fromEntries(Object.entries(t).sort(([[e],[r]])=>e.localeCompare(r)))),"utf8").toString("base64url")}function Vt(t){let e=Buffer.from(t,"base64url").toString("utf8"),{issues:r,output:o,success:n}=(0,f.safeParse)(Ft,e,{abortEarly:!0});return n?[null,o]:[r]}var f,$e,Ft,k,ie=D(()=>{"use strict";p();f=require("valibot"),$e=/^(postgres|postgresql):\/\//,Ft=(0,f.pipe)((0,f.string)(),(0,f.parseJson)(),(0,f.object)({databaseUrl:(0,f.pipe)((0,f.string)(),(0,f.url)(),(0,f.regex)($e)),name:(0,f.optional)((0,f.pipe)((0,f.string)(),(0,f.minLength)(1))),shadowDatabaseUrl:(0,f.pipe)((0,f.string)(),(0,f.url)(),(0,f.regex)($e))}));k=async(t,e)=>{let{authorization:r}=t,{HTTPException:o}=await import("hono/http-exception");if(!r)throw new o(401,{message:"Missing API Key"});let[n,s="",a]=r.split(" ");if(n!=="Bearer"||a)throw new o(401,{message:"Invalid API Key"});let[i,c]=Vt(s);if(i)throw new o(401,{message:"Invalid API Key",cause:i.join(", ")});let{databaseUrl:u,name:l,shadowDatabaseUrl:g}=c,{name:b}=e.get("serverState");if(!l)throw new o(401,{message:`Wrong API Key; The Prisma Dev server running at port ${e.get("port")} requires an API Key from a newer version of \`prisma dev\`. Check the "${b}" server's output for the updated \`DATABASE_URL\` value.`});if(l!==b)throw new o(401,{message:`Wrong API Key; The Prisma Dev server running at port ${e.get("port")} is named "${b}", but the API Key is for "${l}"`});let{hostname:R,port:x}=new URL(u),{port:q}=e.get("db"),{hostname:Ct,port:Bt}=new URL(g),Ht=e.get("shadowDBPort");if(R!=="localhost"||Number(x)!==q||Ct!=="localhost"||Number(Bt)!==Ht)throw new o(401,{message:"Wrong API Key; Check your Prisma schema's `provider.url` value (probably defined in `.env`'s `DATABASE_URL` environment variable) is aligned with `prisma dev`'s output"});return{decodedAPIKey:c}}});function de(t,{suffix:e="nodejs"}={}){if(typeof t!="string")throw new TypeError(`Expected a string, got ${typeof t}`);return e&&(t+=`-${e}`),z.default.platform==="darwin"?Gt(t):z.default.platform==="win32"?Kt(t):Qt(t)}var h,ce,z,O,ue,B,Gt,Kt,Qt,ke=D(()=>{"use strict";p();h=w(require("path"),1),ce=w(require("os"),1),z=w(require("process"),1),O=ce.default.homedir(),ue=ce.default.tmpdir(),{env:B}=z.default,Gt=t=>{let e=h.default.join(O,"Library");return{data:h.default.join(e,"Application Support",t),config:h.default.join(e,"Preferences",t),cache:h.default.join(e,"Caches",t),log:h.default.join(e,"Logs",t),temp:h.default.join(ue,t)}},Kt=t=>{let e=B.APPDATA||h.default.join(O,"AppData","Roaming"),r=B.LOCALAPPDATA||h.default.join(O,"AppData","Local");return{data:h.default.join(r,t,"Data"),config:h.default.join(e,t,"Config"),cache:h.default.join(r,t,"Cache"),log:h.default.join(r,t,"Log"),temp:h.default.join(ue,t)}},Qt=t=>{let e=h.default.basename(O);return{data:h.default.join(B.XDG_DATA_HOME||h.default.join(O,".local","share"),t),config:h.default.join(B.XDG_CONFIG_HOME||h.default.join(O,".config"),t),cache:h.default.join(B.XDG_CACHE_HOME||h.default.join(O,".cache"),t),log:h.default.join(B.XDG_STATE_HOME||h.default.join(O,".local","state"),t),temp:h.default.join(ue,e,t)}}});function Le(t,e){return`${He.cache}/engine/${t}/${e}`}function F(t){return`${He.data}/${t}`}async function je(t){try{return await(0,v.access)(t,v.constants.F_OK),!0}catch(e){if(le(e))return!1;throw e}}async function Me(t,e){let r=await Jt(t);await(0,v.writeFile)(e,r),await(0,v.chmod)(e,"755")}async function Ue(t,e){await t.stream().pipeTo(X.WriteStream.toWeb((0,X.createWriteStream)(e,{encoding:"utf-8"})))}function le(t){return t!=null&&typeof t=="object"&&"code"in t&&t.code==="ENOENT"}async function Ne(t){try{return await(0,v.readFile)(t,{encoding:"utf-8"})}catch(e){if(le(e))return null;throw e}}async function qe(t){await(0,v.mkdir)(t,{recursive:!0})}async function Fe(t,e){try{return(await(0,v.readdir)(t,{withFileTypes:!0})).reduce((o,n)=>(n.isDirectory()&&!n.name.startsWith(".")&&(!e||(0,Be.default)(e,n.name))&&o.push(n.name),o),[])}catch(r){if(le(r))return[];throw r}}var X,v,Ie,Ce,Be,He,Jt,Y=D(()=>{"use strict";p();X=require("fs"),v=require("fs/promises"),Ie=require("util"),Ce=require("zlib");ke();Be=w(require("zeptomatch"),1),He=de("prisma-dev"),Jt=(0,Ie.promisify)(Ce.unzip)});function te(t){let e,r,o=new Promise((a,i)=>{e=a,r=i}),n=a=>{n=s=null,r(a),t?.onRejected?.(a),t?.onFulfilled?.()},s=a=>{s=n=null,e(a),t?.onResolved?.(a),t?.onFulfilled?.()};return{isFulfilled:()=>s===n,promise:o,reject:a=>n?.(a),resolve:a=>s?.(a)}}var he=D(()=>{"use strict";p()});function re(t,e){return console.error(t),t instanceof V?e.json({EngineNotStarted:{reason:{EngineStartupError:{logs:[],msg:t.message}}}},500):t instanceof M?e.text(t.responseBody,t.statusCode):e.body(null,500)}var Ye,Ze,et,tt,rt,ot,or,nr,Xe,U,V,M,ge=D(()=>{"use strict";p();Ye=require("child_process"),Ze=require("events"),et=require("fs/promises"),tt=require("path"),rt=require("timers/promises");he();ot=require("std-env");Y();({PRISMA_DEV_FORCE_ENGINE_BINARY_DOWNLOAD:or,PRISMA_DEV_FORCE_ENGINE_BINARY_PATH:nr,PRISMA_DEV_FORCE_NETWORK_DELAY_MS:Xe}=ot.process.env),U=class t{static#r=new Map;#e;#t;constructor(e){this.#e=e,this.#t=null}static async get(e){let{debug:r}=e,o=`${e.schemaHash}:${e.clientVersion}`;try{let n=t.#r.get(o);if(n)return n;let s=new t(e);return t.#r.set(o,s),r&&console.debug("[Query Engine] starting...",e),await s.start(),r&&console.debug("[Query Engine] started!"),s}finally{t.stopAll(o)}}static async stopAll(e){let o=(await Promise.allSettled(Array.from(t.#r.entries()).filter(([n])=>n!==e).map(async([n,s])=>{try{await s.stop()}finally{t.#r.delete(n)}}))).filter(n=>n.status==="rejected").map(n=>n.reason);if(o.length>0)throw new AggregateError(o,"Failed to stop engines")}async commitTransaction(e,r){return await this.#i(e,r,"commit")}async request(e,r){let{url:o}=await this.start(),n=this.#o(r),s=await fetch(o,{body:typeof e=="string"?e:JSON.stringify(e),headers:{...n,"Content-Type":"application/json"},method:"POST"});if(!s.ok)throw await M.fromResponse(s);return await s.text()}async rollbackTransaction(e,r){return await this.#i(e,r,"rollback")}async startTransaction(e,r){let{url:o}=await this.start(),n=this.#o(r),s=await fetch(`${o}/transaction/start`,{body:JSON.stringify(e),headers:{...n,"Content-Type":"application/json"},method:"POST"});if(!s.ok)throw await M.fromResponse(s);return await s.json()}async start(){if(this.#t!=null)return await this.#t;let{promise:e,reject:r,resolve:o}=te();this.#t=e;let n=nr||await this.#s();this.#e.debug&&console.debug("[Query Engine] spinning up at path...",n);let{proxySignals:s}=await import("foreground-child/proxy-signals"),a=(0,Ye.spawn)(n,["--enable-raw-queries","--enable-telemetry-in-response","--port","0"],{env:{LOG_QUERIES:"y",PRISMA_DML:this.#e.base64Schema,QE_LOG_LEVEL:"TRACE",RUST_BACKTRACE:"1",RUST_LOG:"info"},stdio:["ignore","pipe","pipe"],windowsHide:!0});s(a),a.stderr.setEncoding("utf8"),a.stdout.setEncoding("utf8");let i=l=>{let g=l.split(`
